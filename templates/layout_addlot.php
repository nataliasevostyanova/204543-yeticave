...
<!-- начало формы-->
 <?php $classname = isset($errors) ? "form--invalid" : "form--add-lot container";?> 
 <form class="<?=$classname;?>" action="add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
    ...
    <!--категория -->
        <div class="form__item <?=isset($errors['category']) ? 'form__item--invalid' : '';?>">
          ...
          <label for="category">Категория</label>
           <select name="category" value="$cats;" required>
    ...
    <!--исходный <div class="form__item form__item--file"> --> <!-- form__item--uploaded -->
      ...
      <div class="form__container-three">
        ...
        <div class="form__item form__item--small <?=$classname?>">
          ...
          <input class="" id="lot-rate" type="number" name="lot-rate" placeholder="0" value="<?=$value;?>" required>
        ...
        <!--дата окончания торгов-->
         <?php $classname = isset($errors['lot-date']) ? "form--invalid" : "";
               $value = isset($lot['lot-date']) ? $end_time : "";?>
